...
public class Level2 {
	...
	public void lvl2(Stage primaryStage){
		...
		background2.add(new Log("file:src/p4_group_8_repo/Bird2-right.PNG", 100, 0, 166, 0.75));
		background2.add(new Log("file:src/p4_group_8_repo/Bird2-right.PNG", 100, 220, 166, 0.75));
		background2.add(new Log("file:src/p4_group_8_repo/Bird2-right.PNG", 100, 440, 166, 0.75));
		background2.add(new Log("file:src/p4_group_8_repo/Bird2-right.PNG", 100, 550, 166, 0.75));
		...
		background2.add(new Log("file:src/p4_group_8_repo/Birds2-right.PNG", 150, 270, 329, 1.40));
		background2.add(new Log("file:src/p4_group_8_repo/Birds2-right.PNG", 150, 490, 329, 1.40));
		...
		*/
		...
		//End end4 = new End();
		//End end5 = new End();
		background2.add(new End2(13,96));
		background2.add(new End2(141,96));
		background2.add(new End2(141 + 141-13,96));
		background2.add(new End2(141 + 141-13+141-13+1,96));
		background2.add(new End2(141 + 141-13+141-13+141-13+3,96));
		animal = new Animal2("file:src/p4_group_8_repo/froggerUp.png");
